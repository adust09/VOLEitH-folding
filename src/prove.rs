...
// fn generate_and_verify_proof_fp() -> Result<()> {
//     // Set file paths for Fp implementation
//     let circuit_path = Path::new("src/circuits/fp/poseidon.txt");
//     println!("Circuit path: {:?}", circuit_path);
...
//     // Set private_input file path
//     let private_input_path = Path::new("src/circuits/fp/poseidon_private.txt");
//     println!("Private input path: {:?}", private_input_path);
...
//     // Set public_input file path
//     let public_input_path = Path::new("src/circuits/fp/poseidon_public.txt");
//     println!("Public input path: {:?}", public_input_path);
...
//     // Generate proof
//     println!("Generating proof for Fp implementation...");
//     let proof = Proof::<InsecureVole>::prove::<_, _>(
//         circuit,
//         private_input_path,
//         &mut transcript_instance,
...
//     // Description of Fp Poseidon hash function implementation
//     println!("\nFp Poseidon hash function implementation:");
//     println!("1. Input: 3 values");
