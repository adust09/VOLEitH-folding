...
fn bench_f64_single(c: &mut Criterion) {
    let circuit_path = "circuits/poseidon/f64/single/circuit.txt";
    let private_path = "circuits/poseidon/f64/single/private.txt";
    let public_path = "circuits/poseidon/f64/single/public.txt";

    run_detailed_benchmark(c, "F64_Single_Hash", circuit_path, private_path, public_path);
}

fn bench_f64_hash_chain_10(c: &mut Criterion) {
    let circuit_path = "circuits/poseidon/f64/hash_chain_10/circuit.txt";
    let private_path = "circuits/poseidon/f64/hash_chain_10/private.txt";
    let public_path = "circuits/poseidon/f64/hash_chain_10/public.txt";

    run_detailed_benchmark(c, "F64_Hash_Chain_10", circuit_path, private_path, public_path);
}

criterion_group!(benches, bench_f64_single, bench_f64_hash_chain_10);
