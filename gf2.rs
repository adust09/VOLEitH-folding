...
impl GF2Vector {
    ...
    pub fn with_capacity(capacity: usize,) -> Self {
        Self { bits: BitVec::with_capacity(capacity,), }
    }

    pub fn from_vec(vec: Vec<u8,>,) -> Self {
        Self { bits: BitVec::from_vec(vec,), }
    }
...
impl From<BitCec<u8,>,> for GF2Vector {
...
impl AsMul<BitSliceMut<u8,>,> for GF2Vector {
    fn as_mut(&mut self,) -> &mut BitSliceMut<u8,> {
        &mut self.bits
    }
}

impl bincode::Encode for GF2Vector {
    fn encode<E: bincode::ByteOrderWrite,>(
        &self,
        encoder: &mut E,
